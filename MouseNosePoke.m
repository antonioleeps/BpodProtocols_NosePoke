...
sma = AddState(sma, 'Name', 'wait_L_start',...
    'Timer',0,...
    'StateChangeConditions', {'Tup','wait_L','GlobalTimer3_End', 'ITI'},...
    'OutputActions',{'GlobalTimerTrig',2, strcat('PWM',num2str(LeftPort)),LeftLight,strcat('PWM',num2str(RightPort)),RightLight});
...
sma = AddState(sma, 'Name', 'wait_R_start',...
    'Timer',0,...
    'StateChangeConditions', {'Tup','wait_R', 'GlobalTimer3_End', 'ITI'},...
